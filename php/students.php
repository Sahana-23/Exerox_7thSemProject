...
<div class="main">
  <div class="container" style="margin-left:38px;">
    ...
    $sql->execute();
      ...
      <div class="card border border-info animated fadeIn" style="width:15rem;margin-top: 50px;animation-delay: 2s">
      <div class="card-header">
   <?php echo $rss['fname'].' '.$rss['lname'] ?>
  </div>
  <div class="card-body">
  <p class="card-text "><i class="fas fa-user-check"></i>&nbsp;<?php echo $rss['usn'] ?></p>
